...
polynomial for each table size was chosen such that _PyDict_DelItemIfx was a primitive root.
...
{
    return _Py_SIZE_ROUND_UP(capacity + 2, sizeof(PyObject *));
}
